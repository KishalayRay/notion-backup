  ...
  try {
    ...
    const update = {
      $set: {
        ...
        movieGenre: req.body.movieGenre.split(",")[0],
        movieDuration: parseFloat(req.body.movieDuration) || 0,
        movieRating: parseFloat(req.body.movieRating) || 0,
        movieYear: parseFloat(req.body.movieYear) || 0,
      },
